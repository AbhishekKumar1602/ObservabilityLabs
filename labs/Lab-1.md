...
The next block defines explicit shortcuts used by all labs. Read it before sourcing it. It enables Bash `pipefail` so a failed request or assertion is not hidden by a successful final pipeline command. It does not load passwords into your host shell or print connection strings.
...
## 33. End State and Transition to Lab 02

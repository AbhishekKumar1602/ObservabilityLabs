...
| `labs/Lab-1.md` through `labs/Lab-50.md`      | Complete hands-on lab guides                                                      |
...
| **Lab** | **Guide**                                                                                 |
|---------|-------------------------------------------------------------------------------------------|
| 1       | [Follow One FastAPI Request End-to-End](labs/Lab-1.md)                                    |
| 2       | [PostgreSQL Persistence and Transaction Boundaries](labs/Lab-2.md)                        |
| 3       | [Redis Cache-Aside and Graceful Degradation](labs/Lab-3.md)                               |
| 4       | [Liveness, Readiness, and Dependency Health](labs/Lab-4.md)                               |
| 5       | [Docker Compose Networking, Storage, and Restart Behavior](labs/Lab-5.md)                 |
| 6       | [Structured Logging, Request IDs, and Evidence Capture](labs/Lab-6.md)                    |
| 7       | [Raw OpenMetrics Before Prometheus](labs/Lab-7.md)                                        |
| 8       | [Instrument RED Metrics](labs/Lab-8.md)                                                   |
| 9       | [Metric Design, Business Metrics, and Cardinality](labs/Lab-9.md)                         |
...
Complete this section before opening `labs/Lab-1.md`.
...
Open [`labs/Lab-1.md`](labs/Lab-1.md) and follow its starting-state checks and baseline initialization procedure.
...
- [ ] The complete repository contains `Lab-1.md` through `Lab-50.md`.
...
- [ ] `labs/Lab-1.md` is the next step.
